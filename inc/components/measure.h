...
/*!******************************************************************
 * \enum MEASURE_channel_result_t
 * \brief Single channel results structure.
 *******************************************************************/
typedef struct {
...
/*!******************************************************************
 * \fn MEASURE_status_t MEASURE_get_ac_channel_detect_flag(uint8_t ac_channel_index, uint8_t* current_sensor_connected)
...
/*!******************************************************************
 * \fn MEASURE_status_t MEASURE_get_ac_channel_data(uint8_t ac_channel_index, MEASURE_channel_result_t* ac_channel_data)
 * \brief Get AC channel data.
 * \param[in]  	ac_channel_index: AC channel index to read.
