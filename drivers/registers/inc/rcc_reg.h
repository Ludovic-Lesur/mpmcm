...
typedef struct {
	...
	volatile uint32_t RESERVED0[2]; // Reserved 0x10.
	...
	volatile uint32_t RESERVED1; 	// Reserved 0x24.
	volatile uint32_t AHB1RSTR;  	// RCC AHB1 peripheral reset register.
	volatile uint32_t AHB2RSTR;  	// RCC AHB2 peripheral reset register.
	volatile uint32_t AHB3RSTR;  	// RCC AHB3 peripheral reset register.
	volatile uint32_t RESERVED2; 	// Reserved 0x34.
	...
	volatile uint32_t RESERVED4; 	// Reserved 0x54.
	...
	volatile uint32_t RESERVED5; 	// Reserved 0x64.
	...
	volatile uint32_t RESERVED6; 	// Reserved 0x74.
	...
	volatile uint32_t RESERVED7; 	// Reserved 0x84.
	volatile uint32_t CCIPR;     	// RCC peripheral independent clock configuration register 1.
	volatile uint32_t RESERVED8;	// Reserved 0x8C.
